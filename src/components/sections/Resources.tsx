      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          {resources.items.map((item, i) => {
            // comingSoon cards are non-navigating — render as div to avoid
            // broken links to pages that don't exist yet.
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-3 border-t border-black/[0.05]">
                  ...
                  {item.comingSoon ? (
                    <span className="font-body text-[11px] text-[var(--text-muted)] italic">
                      Coming soon
                    </span>
                  ) : (
                    <span
